...
namespace hakoniwa.objects.core
{
    ...
    {
        private static Dictionary<Collider, TargetColliderInfo> colliderInfoMap = new Dictionary<Collider, TargetColliderInfo>();
        public static TargetColliderInfo GetInfo(Collider collider)
        {
            if (colliderInfoMap.TryGetValue(collider, out TargetColliderInfo info))
            {
                return info;
            }
        ...
        private static void PutInfo(Collider collider, TargetColliderInfo obj)
        {
